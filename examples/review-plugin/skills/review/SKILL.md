---
description: Review the current changes (deterministically read the diff + LLM review) Before committing or merging, when you need to review the correctness and quality of code changes
