...
const CLAUDE_START = '<!-- geneprint:rules:start -->';
const CLAUDE_END = '<!-- geneprint:rules:end -->';
...
// 写 .cursor/rules/<name>.mdc + 把规则刻进 CLAUDE.md 的 geneprint 托管块。
export function compileRules(targetDir) {
  ...
  const body = `# Project rules (geneprint)\n\n${claudeRulesBody(rules)}`;
